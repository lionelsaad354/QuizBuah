package com.example.android.simplequiz;
...
public class MainActivity extends AppCompatActivity{
    ...
    private void setUpWaktu() {
        mCountDownTimer = new CountDownTimer(detik, 100)
        {
            ...
            public void onTick(long millisUntilFinished)
            {
                ...
                txtwaktu.setText("Sisa waktu: " +(int) (millisUntilFinished / 6000) +
                        " detik");
            }
            ...
            {
                // TODO Auto-generated method stub
                txtwaktu.setText("Sisa waktu: 0 detik");
                Toast.makeText(getApplicationContext(), "Waktu Habis",
